...
int main(int argc, char **argv)
{
   ...
   pubBall = nh.advertise<core_msgs::ball_position>("/ball_position", 5); //setting publisher
   pubGoal = nh.advertise<core_msgs::goal_position>("/goal_position", 5); //setting publisher
